...
== Requirements
Scribd_fu requires the wicked awesome Attachment_fu plugin. You probably already
have it installed.  You also need the rscribd gem.
...
Feel free to check out my blog (http://blog.matt-darby.com) or to recommend me on http://workingwithrails.com
