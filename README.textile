...
<pre>config.gem 'mdarby-scribd_fu', :lib => 'scribd_fu',
...
To install it and the rscribd gem.
...
* Copy the scribd_fu/scribd.yml.example file from the gem to config/scribd.yml
  and fill it out with your Scribd login credentials.
